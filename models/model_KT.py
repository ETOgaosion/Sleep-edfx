...
class RA(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.topic_model.load_emb(embs)
        self.seq_model = AttnSeqModel(args['topic_size'], args['seq_hidden_size'], args['k'],
...
class RADecay(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.topic_model = TopicRNNModel(wcnt, emb_size, args['topic_size'])
        self.topic_model.load_emb(embs)
        self.seq_model = AttnSeqTimeDecayModel(args['topic_size'], args['seq_hidden_size'], args['k'], args['score_mode'])
        self.vs = None
        self.hs = None
